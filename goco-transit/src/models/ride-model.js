...
class RideModel {
  ...
  passengerUsernames; // A comma-delimited array of the usernames of the Ride's passengers 
  requestIDs; // A comma-delimited array of the IDs of the Ride's pending Requests
